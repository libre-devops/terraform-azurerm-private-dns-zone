...
variable "privatelink_dns_zones" {
  ...
  default = [
    ...
    },
    {
      ...
      forwarders    = "westeurope.batch.azure.com"
    },
    {
    ...
    },
    {
      ...
      forwarders    = "westeurope.azmk8s.io"
    },
    {
    ...
    },
    {
      ...
      zone_name     = "privatelink.westeurope.backup.windowsazure.com"
      forwarders    = "westeurope.backup.windowsazure.com"
    },
    {
      resource_type = "Microsoft.RecoveryServices/vaults"
      subresource   = "AzureSiteRecovery"
      zone_name     = "privatelink.siterecovery.windowsazure.com"
      forwarders    = "westeurope.siterecovery.windowsazure.com"
    },
    {
    ...
    },
    {
      ...
      subresource   = "afs"
      zone_name     = "westeurope.privatelink.afs.azure.net"
      forwarders    = "westeurope.afs.azure.net"
    },
    {
    ...
    },
    {
      ...
      subresource   = ""
      zone_name     = "privatelink.westeurope.kusto.windows.net"
      forwarders    = "westeurope.kusto.windows.net"
    },
    {
